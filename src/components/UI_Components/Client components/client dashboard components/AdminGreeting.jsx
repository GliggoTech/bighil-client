...
const AdminGreeting = () => {
  ...
  return (
    <div className="mb-8 relative overflow-hidden transition-all duration-300 group">
      <div className="bg-surface-light dark:bg-surface-dark rounded-2xl shadow-lg  p-6 backdrop-blur-lg transition-all duration-300 hover:shadow-xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="flex-1 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl font-bold text-text_color dark:text-text-light tracking-tight">
                {greeting},{" "}
